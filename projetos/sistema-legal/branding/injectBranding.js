...
(function() {
  ...
  BRANDING.documentStyles = [
    ...
    '.doc-body{max-width:210mm;margin:0 auto;text-align:justify;font-family:"Times New Roman",Times,Georgia,serif;font-size:12pt}',
    '.doc-body p,.doc-body li{text-align:justify;text-align-last:left;line-height:1.65;text-justify:inter-word;-webkit-hyphens:auto;hyphens:auto}',
    ...
    '.minuta-paragrafo{font-family:"Times New Roman",Times,Georgia,serif;font-size:12pt;margin:0 0 14pt 0;text-align:justify;text-align-last:left;text-justify:inter-word;line-height:1.5;hyphens:auto;-webkit-hyphens:auto;word-spacing:normal;letter-spacing:0.01em}',
